...
class EditForm extends React.Component {
    ...
    async componentDidMount() {
        ...
        this.selectedSelectType = this.props.data.filter_type;
        let tagArray = JSON.parse(this.props.data.tag_array);
        this.selectTagType = tagArray;
        this.setState({
            isLoading : false,
            shopifyFilter : JSON.parse(this.props.data.shopify_filter)
        });
    }
        ...
        return (
            ...
            <Content style={{ background: "#fff", marginLeft: "10px" }}>
                ...
                initialValues={{
                    ...
                    filter_type : this.props.data.filter_type,
                    shopify_filter : {}
                }}
                                            ...
                                            {this.props.t("select_filter_label")}
                                                <Field
                                                    ...
                                                    <Select
                                                        ...
                                                        showArrow={true}
                                                        defaultValue={this.selectedSelectType}
                                                        style={{width : "100%"}}
                                                        filterOption={false}
                                                        onChange={value => {
                                                    ...
                                                    <div>
                                                        ...
                                                        <Field
                                                            ...
                                                            <Select
                                                                ...
                                                                defaultValue={this.selectTagType}
                                                                showArrow={true}
                                                                style={{width : "100%"}}
                                                                filterOption={false}
                                                                onChange={value => {
